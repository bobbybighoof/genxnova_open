...
void main(void)
{
   ...
   vec3 binormal = normalize(tangentAt(nNormal));
   vec3 tangent  = normalize(cross(nNormal, binormal));
   
   vNormal              = gl_NormalMatrix * nNormal;
   ...
   //vLightDirectionInWorldSpace =(fvLightPosition - gl_Position)  ;
