...
function create(dialogObject, bindings)
  ...
  "Check out this cool display behind me!\n\n"..
  "You can put in any text you like and even use different colours, sizes and variables from your ship\n"..
  "like the current power supply."
