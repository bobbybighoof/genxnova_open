...
function create(dialogObject, bindings)
  ...
  "When you go out exploring, you will find some abandoned stations. I've heard you can either\n"..
  "salvage them for scrap metal, or even repair them to use as your own station."..
  "However...I've also heard stories of something lurking in there, but I don't believe a word of that."
